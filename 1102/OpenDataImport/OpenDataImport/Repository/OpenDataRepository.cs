...
namespace OpenDataImport.Repository
{
    class OpenDataRepository
    {
        public string ConnectionString
        {
            get
            {
                return @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\[高科大]軟體工程\github\1102\OpenDataImport\OpenDataImport\App_Data\Database.mdf;Integrated Security=True";
            }
        }
